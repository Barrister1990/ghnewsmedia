...
export const useSEO = () => {
  ...
  }, [articles, categories, seoService]);
  ...
  return {
    generateSitemap: (articlesData: any[], categoriesData: any[]) => 
      seoService.generateSitemap(articlesData, categoriesData),
    generateRSSFeed: (articlesData: any[]) => 
      seoService.generateRSSFeed(articlesData),
    generateArticleStructuredData: (article: any) => 
      seoService.generateEnhancedStructuredData(article),
    generateBreadcrumbData: (items: any[]) => 
